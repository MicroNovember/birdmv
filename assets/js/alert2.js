        ...
        return Swal.fire({
            ...
            html: `
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-400 text-sm mb-4">กรุณาใส่รหัส VIP 4 ตัวเพื่อเข้าใช้งาน</p>

                    <div class="flex justify-center space-x-2 mb-4">

                        <input type="text" maxlength="1" class="vip-input w-12 h-12 bg-gray-800 border border-gray-600 rounded-lg text-center text-xl font-bold text-white focus:border-gray-500 focus:ring-2 focus:ring-gray-500/20 transition" data-index="0">

                        <input type="text" maxlength="1" class="vip-input w-12 h-12 bg-gray-800 border border-gray-600 rounded-lg text-center text-xl font-bold text-white focus:border-gray-500 focus:ring-2 focus:ring-gray-500/20 transition" data-index="1">

                        <input type="text" maxlength="1" class="vip-input w-12 h-12 bg-gray-800 border border-gray-600 rounded-lg text-center text-xl font-bold text-white focus:border-gray-500 focus:ring-2 focus:ring-gray-500/20 transition" data-index="2">

                        <input type="text" maxlength="1" class="vip-input w-12 h-12 bg-gray-800 border border-gray-600 rounded-lg text-center text-xl font-bold text-white focus:border-gray-500 focus:ring-2 focus:ring-gray-500/20 transition" data-index="3">

                    </div>

                    <div id="vip-error" class="hidden bg-gray-800 border border-gray-600 text-gray-300 px-4 py-3 rounded-lg text-sm"></div>
        ...
        return Swal.fire({
            ...
            html: `
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <button onclick="Alert2.vipLogin()" class="bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 p-4 rounded-xl text-center transition">
